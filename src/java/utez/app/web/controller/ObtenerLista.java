...
import utez.app.web.dao.SelectDao;
...
public class ObtenerLista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {   
                Gson gson = new Gson();        
                List<SelectBean> valores = new ArrayList<SelectBean>();
                ...
                valores = dao.consultar(query);                                                                                
                String json = gson.toJson(valores); 
//convertir lista de elementos SelectBean a json [{"name":"xyz","id":"nn"},... ,{"name":"xyzn","id":"nnm"}]
